...
@TeleOp(name = "SeyiaTOnotDuck2")
public class seyianotduck2 extends LinearOpMode {
    ...
    static final double COUNTS_PER_DEGREE_CORE = (COUNTS_PER_REVOLUTION_PULSE) / 360;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        /*    if ((armMotorDesiredPosition > ArmMotor.getCurrentPosition() ? diffM1 >= -1.0 : diffM1 <= 1.0
            ...
            if (gamepad1.right_bumper) {
                ...
                grappleServo.setPower(-0.5);
                grappleServo1.setPower(0.5);
                sleep(200);
            }else{
            ...
            if(gamepad1.dpad_up){
                ...
                clawTarget = claw.getCurrentPosition() + (COUNTS_PER_DEGREE_CORE * 5);
    ...
    private void rotateArm(double degrees) {
        ...
        setArmMotorsPower(ArmMotor.getTargetPosition() > ArmMotor.getCurrentPosition() ? 0.35 : -0.35);
    }
