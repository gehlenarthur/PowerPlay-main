...
public class Robot2 {
    ...
    public void encoder(double deegres, double time, double power,double counts,double target, DcMotorEx motor) {
    ...
    public void encoderDesaceleracaoMetade(double deegres, double time, double counts, double target,double adicional, DcMotorEx motor) {
    ...
    private void setWheelsPowerFromDegrees(int degrees, double errorInicial) {
        ...
        setWheelsPowerSpeedControl(0.00, 0.00, degrees > 0 ? -(returnpowerImu(degrees, errorInicial) + 0.05) : returnpowerImu(degrees, errorInicial) +  + 0.05, 3 * 560);
    }
